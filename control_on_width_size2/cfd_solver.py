...
class FlowSolver(object):
    ...
    def __init__(self, flow_params, geometry_params, solver_params):    
        ...
        jet = JetBCValue(gtime, length_before_control, step_height, control_width, jet_amplitude_tuning, frequency_amplitude_tuning, frequency_shift_tuning, frequency=0, Q=0, control_evolution=0, degree=1)
