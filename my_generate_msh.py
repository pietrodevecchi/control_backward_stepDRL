...
def generate_mesh(args, template='backward_facing_step.template_geo', dim=2):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-output', default='backward_step.geo', type=str, help='A geofile for writing out geometry')
    # # Geometry
