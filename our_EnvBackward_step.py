...
from our_probes import PressureProbeValues, VelocityProbeValues, TotalrecirculationArea
from our_generate_msh import generate_mesh
from our_flow_solver import FlowSolver
from our_msh_convert import convert
from dolfin import *
...
#------------------------------------------------------------------- Start Class --------------------------------------------------------
    def start_class(self):
        ...
        for contr_term in self.geometry_params['contol_terms']:                          
